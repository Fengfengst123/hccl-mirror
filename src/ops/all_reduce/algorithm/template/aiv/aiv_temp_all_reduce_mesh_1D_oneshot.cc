    ...
    AlgResourceRequest& resourceRequest)
{
    ...
    HCCL_WARNING("[AivTempAllReduceMesh1DOneShot] Resource calculation is temporarily not performed in the template.");
    return HCCL_SUCCESS;
}
...
HcclResult AivTempAllReduceMesh1DOneShot::CalNumBlocks(u32& numBlocks, u64 dataSize, u32 numBlocksLimit)
{
    ...
    HCCL_CONFIG_INFO(
        HCCL_ALG, "[AivTempAllReduceMesh1DOneShot] Actually use core num[%u], limit[%u]", numBlocks, numBlocksLimit);
