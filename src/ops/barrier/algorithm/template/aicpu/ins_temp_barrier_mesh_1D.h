...
#ifndef INS_TEMP_BARRIER_MESH_1D_H
#define INS_TEMP_BARRIER_MESH_1D_H
...
// Barrier 框内 AICPU 模板：仅做 (n-1) 次 Mesh 同步对，不搬运数据。
// 复用 AllGather Mesh1D 的 channel 申请与多线程同步骨架。
...
public:
    ...
    {
        std::string info = "Template of Barrier Mesh with tempRankSize ";
