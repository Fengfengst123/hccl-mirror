    ...
    HcclComm comm, TopoInfoWithNetLayerDetails* topoInfo, const char* algName, const OpParam& param)
{
    ...
    const u64 innerStepNum
        = CalcStepNumByAxes(meshPlanBandwidth, closPlanBandwidth, axes.mesh, axes.clos, maxStepNum, true);
    ...
    const u64 outerStepNum
        = CalcStepNumByAxes(xyBandwidth, thirdPlanBandwidth, axes.mesh * axes.clos, axes.third, maxStepNum, true);
