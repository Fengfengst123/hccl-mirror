...
private:
    ...
    HcclResult FastLaunchTemplateIntra0(
        ...
        InsAlgTemplate0& tempAlgIntra) const;
    HcclResult FastLaunchTemplateInter1(
        const OpParam& param, const u32 kernelNum, TemplateFastLaunchCtx& tempFastLaunchCtxIntra,
        InsAlgTemplate1& tempAlgInter) const;
    HcclResult FastLaunchTemplateInter0(
        const OpParam& param, const u32 kernelNum, TemplateFastLaunchCtx& tempFastLaunchCtxInter,
        InsAlgTemplate1& tempAlgInter) const;
    HcclResult FastLaunchTemplateIntra1(
        const OpParam& param, const u32 kernelNum, TemplateFastLaunchCtx& tempFastLaunchCtxIntra,
        InsAlgTemplate0& tempAlgIntra) const;
    HcclResult FastLaunchTemplateInter01(
        const OpParam& param, const u32 kernelNum, TemplateFastLaunchCtx& tempFastLaunchCtxInter,
        InsAlgTemplate3& tempAlgInter1) const;
    HcclResult FastLaunchTemplateIntra11(
        const OpParam& param, const u32 kernelNum, TemplateFastLaunchCtx& tempFastLaunchCtxIntra,
        InsAlgTemplate2& tempAlgIntra1) const;
    HcclResult FastLaunchTemplateIntra01(
        const OpParam& param, const u32 kernelNum, TemplateFastLaunchCtx& tempFastLaunchCtxIntra,
        InsAlgTemplate2& tempAlgIntra1) const;
    HcclResult FastLaunchTemplateInter11(
        const OpParam& param, const u32 kernelNum, TemplateFastLaunchCtx& tempFastLaunchCtxInter,
        InsAlgTemplate3& tempAlgInter1) const;
