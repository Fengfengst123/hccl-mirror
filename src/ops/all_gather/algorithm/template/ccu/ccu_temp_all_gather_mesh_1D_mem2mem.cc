...
HcclResult CcuTempAllGatherMesh1DMem2Mem::CalcRes(
...
HcclResult
CcuTempAllGatherMesh1DMem2Mem::FastLaunch(const OpParam& param, const TemplateFastLaunchCtx& tempFastLaunchCtx)
{
    (void)param;
...
HcclResult CcuTempAllGatherMesh1DMem2Mem::PrepareLaunchArgs(
    ...
    uint64_t& argSize)
{
    ...
    HCCL_INFO(
        "[CcuTempAllGatherMesh1DMem2Mem::KernelRun] TaskArgs: inputAddr[%llu], outputAddr[%llu], "
...
HcclResult CcuTempAllGatherMesh1DMem2Mem::KernelRun(
...
u64 CcuTempAllGatherMesh1DMem2Mem::GetThreadNum() const { return 1; }
