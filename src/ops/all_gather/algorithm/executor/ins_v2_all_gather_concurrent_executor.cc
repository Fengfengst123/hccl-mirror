...
template <typename AlgTopoMatch, typename InsAlgTemplate0, typename InsAlgTemplate1>
HcclResult InsV2AllGatherConcurrentExecutor<AlgTopoMatch, InsAlgTemplate0, InsAlgTemplate1>::CalcAlgHierarchyInfoV2(
    ...
    HcclComm comm, TopoInfoWithNetLayerDetails* topoInfo, const char* algName, const OpParam& param)
{
    ...
    HCCL_INFO(
        "[InsV2AllGatherConcurrentExecutor][CalcCostCoeff] rankSize=%d, netTypeLevel0=%d, netTypeLevel1=%d", rankSize,
    ...
    if (param.engine == CommEngine::COMM_ENGINE_CCU) {
        CHK_PRT_RET(
            ...
            HCCL_ERROR(
                ...
                resCtx.ccuKernelNum.size(), resCtx.ccuKernels.size()),
            HCCL_E_INTERNAL);
    ...
    InsAlgTemplate1& algTemplate1)
{
    ...
    u32 scratchMultiplierforTemp0 = algTemplate0.CalcScratchMultiple(
        AlgParamsforTemp0.buffInfo.inBuffType, AlgParamsforTemp0.buffInfo.outBuffType);
    u32 scratchMultiplierforTemp1 = algTemplate1.CalcScratchMultiple(
        AlgParamsforTemp1.buffInfo.inBuffType, AlgParamsforTemp1.buffInfo.outBuffType);
    ...
    u32 notifyNumOnMainThread)
{
    ...
    HCCL_INFO(
        "[InsV2AllGatherConcurrentExecutor][FastLaunchSaveCtx] threadNum[%llu], ccuKernelNum[%llu]", threadNum,
        ccuKernelNum);
...
REGISTER_EXECUTOR_BY_TWO_TEMPS(
    HcclCMDType::HCCL_CMD_ALLGATHER, AicpuAllGatherConcurMeshNHR, InsV2AllGatherConcurrentExecutor,
