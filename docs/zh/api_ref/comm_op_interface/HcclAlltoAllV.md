...
<!-- end id13 -->
<!-- npu="310p" id6 -->
- 针对Atlas 300I Duo推理卡，支持的数据类型：int8、uint8、int16、uint16、int32、uint32、int64、uint64、float16、float32、float64。
<!-- end id6 -->
...
<!-- npu="910" id13 -->
- 针对Atlas训练系列产品，AlltoAllV的通信域需要满足如下约束：
...
- 针对Atlas训练系列产品，如果是单Server场景，要求网卡的状态是“up”，否则此接口会执行失败。
<!-- end id13 -->
<!-- npu="310p" id14 -->
