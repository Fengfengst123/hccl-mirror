...
- false（默认值）：关闭确定性计算。
  <!-- npu="950" id6 -->
  - 针对Ascend 950PR&950DT系列产品：所有归约类通信算子强制为确定性计算，不受此配置影响。
  <!-- end id6 -->
  <!-- npu="A3" id4 -->
  - 针对Atlas A3系列产品：
  ...
  <!-- end id4 -->
  <!-- npu="910b" id5 -->
  - 针对Atlas A2系列产品：所有归约类算子默认关闭确定性计算。
  <!-- end id5 -->

- true：开启归约类通信算子的确定性计算。
  <!-- npu="950" id9 -->
  - 针对Ascend 950PR&950DT系列产品：所有归约类算子强制为确定性计算，且不受此配置影响。
  <!-- end id9 -->
  <!-- npu="A3" id8 -->
  - 针对Atlas A3系列产品：
    - 若归约类通信算子展开模式为AI CPU：所有归约类算子强制为确定性计算，不受此配置影响。
  ...
  <!-- end id8 -->
  <!-- npu="910b" id7 -->
  - 针对Atlas A2系列产品：支持AllReduce、ReduceScatter、ReduceScatterV、Reduce算子。
  <!-- end id7 -->
